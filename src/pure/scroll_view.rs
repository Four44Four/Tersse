...
pub(crate) fn max_scroll_offset(total_lines: usize, viewport_height: usize) -> usize {
...
pub(crate) fn clamp_scroll_offset(offset: usize, total_lines: usize, viewport_height: usize) -> usize {
    offset.min(max_scroll_offset(total_lines, viewport_height))
}

/// Scroll up by one line.
pub(crate) fn scroll_line_up(offset: usize) -> usize {
    offset.saturating_sub(1)
}

/// Scroll down by one line.
pub(crate) fn scroll_line_down(offset: usize, total_lines: usize, viewport_height: usize) -> usize {
