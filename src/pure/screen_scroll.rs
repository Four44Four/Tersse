...
pub(crate) fn screen_content_height(element_spans: &[(u16, usize)]) -> usize {
    let mut height = 0;
...
pub(crate) fn screen_scroll_to_show_cursor_row(
    cursor_row: usize,
